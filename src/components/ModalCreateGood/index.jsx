                      ...
                      <div className="text-sm p-6 text-gray-500">
                        ...
                        <div className="flex flex-row items-center mb-5">
                          ...
                          <div className="relative">
                            <span className="text-gray-200 ml-5 absolute top-2.5 left-2.5 bottom-0"></span>
                            <input
                              type="number"
                              name="stock"
                              id="stock"
                              className="border-2 ml-5 w-full text-right border-gray-200 rounded-lg pl-7 pr-3 py-2"
                              value={stockValue}
                        ...
                        <div className="flex flex-row items-center mb-5">
                          ...
                          <div className="relative">
                            <span className="text-gray-200 ml-5 absolute top-2.5 left-2.5 bottom-0">
                              Rp
                            </span>
                            <input
                              type="number"
...
export default ModalCreateGood;
